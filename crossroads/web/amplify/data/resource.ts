  ...
  .schema({
    ...
    User: a
      .model({
        ...
        posts: a.hasMany("Post", "userId"), // A user can create multiple detailed posts (One-to-Many)
    ...
    Post: a
      .model({
        ...
        userId: a.string().required(), // Connects post to the user who created it
    ...
    Business: a
      ...
      .authorization((allow) => [
        ...
        // allow.publicApiKey().to(["read"]), // Everyone can read business information
      ]),
    Review: a
      .model({
        businessId: a.string().required(),
