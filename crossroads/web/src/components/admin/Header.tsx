                ...
                <div className="absolute z-50 mt-2 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600 right-0 top-12">
                  <div className="px-4 py-3">
                    <p className="text-sm text-gray-900 dark:text-white">
                      {userAttributes?.preferred_username ?? "N/A"} -{" "}
                  ...
                  <ul className="py-1">
                    ...
                    <li>
                      <button
                        onClick={signOut}
                        className="block cursor-pointer w-full text-left px-4 py-2 text-sm text-gray-700 bg-transparent border-none outline-none hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white"
                      >
                        Sign out
                      </button>
                    </li>
