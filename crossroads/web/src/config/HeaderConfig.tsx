...
import { APP_ROUTES } from "./UrlConfig";
...
export const AppNavigation: AppNavigationLinks[] = [
  ...
  {
    title: "Businesses",
    link: APP_ROUTES.ADMIN.BUSINESSES,
    iconPaths: [
  ...
  {
    title: "Settings",
    link: APP_ROUTES.ADMIN.CROSSROADS_SETTINGS,
    iconPaths: [
